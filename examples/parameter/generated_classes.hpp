...
class SystemSetting {
 public:
  ...
  std::vector<double> IdleTaskCpuAffinity() const { return idle_task_cpu_affinity_; }
...
class Executer {
 public:
  ...
  const auto_Task::auto_TaskConfig::auto_Executer::auto_TaskSetting::TaskSetting& TaskSetting() const { return task_setting_; }

  const auto_Task::auto_TaskConfig::auto_Executer::auto_SystemSetting::SystemSetting& SystemSetting() const { return system_setting_; }
...
class ResidentGroup {
 public:
  ...
  std::vector<auto_Task::auto_TaskConfig::auto_TaskList::auto_ResidentGroup::auto_NodeList::NodeList> NodeList() const { return node_list_; }

  const auto_Task::auto_TaskConfig::auto_TaskList::auto_ResidentGroup::auto_TaskSetting::TaskSetting& TaskSetting() const { return task_setting_; }
...
class TaskList {
 public:
  ...
  std::vector<auto_Task::auto_TaskConfig::auto_TaskList::auto_ResidentGroup::ResidentGroup> ResidentGroup() const { return resident_group_; }
...
class TaskConfig {
 public:
  ...
  const auto_Task::auto_TaskConfig::auto_Executer::Executer& Executer() const { return executer_; }

  const auto_Task::auto_TaskConfig::auto_TaskList::TaskList& TaskList() const { return task_list_; }
...
class Executer {
 public:
  ...
  const auto_Task::auto_TaskConfig2::auto_Executer::auto_TaskSetting::TaskSetting& TaskSetting() const { return task_setting_; }

  const auto_Task::auto_TaskConfig2::auto_Executer::auto_SystemSetting::SystemSetting& SystemSetting() const { return system_setting_; }
...
class ResidentGroup {
 public:
  ...
  std::vector<auto_Task::auto_TaskConfig2::auto_TaskList::auto_ResidentGroup::auto_NodeList::NodeList> NodeList() const { return node_list_; }

  const auto_Task::auto_TaskConfig2::auto_TaskList::auto_ResidentGroup::auto_TaskSetting::TaskSetting& TaskSetting() const { return task_setting_; }
...
class TaskList {
 public:
  ...
  std::vector<auto_Task::auto_TaskConfig2::auto_TaskList::auto_ResidentGroup::ResidentGroup> ResidentGroup() const { return resident_group_; }
...
class TaskConfig2 {
 public:
  ...
  const auto_Task::auto_TaskConfig2::auto_Executer::Executer& Executer() const { return executer_; }

  const auto_Task::auto_TaskConfig2::auto_TaskList::TaskList& TaskList() const { return task_list_; }
...
class Executer {
 public:
  ...
  const auto_Task2::auto_TaskConfig2::auto_Executer::auto_TaskSetting::TaskSetting& TaskSetting() const { return task_setting_; }

  const auto_Task2::auto_TaskConfig2::auto_Executer::auto_SystemSetting::SystemSetting& SystemSetting() const { return system_setting_; }
...
class ResidentGroup {
 public:
  ...
  std::vector<auto_Task2::auto_TaskConfig2::auto_TaskList::auto_ResidentGroup::auto_NodeList::NodeList> NodeList() const { return node_list_; }

  const auto_Task2::auto_TaskConfig2::auto_TaskList::auto_ResidentGroup::auto_TaskSetting::TaskSetting& TaskSetting() const { return task_setting_; }
...
class TaskList {
 public:
  ...
  std::vector<auto_Task2::auto_TaskConfig2::auto_TaskList::auto_ResidentGroup::ResidentGroup> ResidentGroup() const { return resident_group_; }
...
class TaskConfig2 {
 public:
  ...
  const auto_Task2::auto_TaskConfig2::auto_Executer::Executer& Executer() const { return executer_; }

  const auto_Task2::auto_TaskConfig2::auto_TaskList::TaskList& TaskList() const { return task_list_; }
