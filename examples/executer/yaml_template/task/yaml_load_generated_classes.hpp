...
public:
    ...
    void update_from_yaml(const YAML::Node& auto_yaml_node) {
        ...
        const auto_TaskConfig::auto_ExecuterSetting::auto_TimerSetting::TimerSetting& TimerSetting() const {
            return timer_setting_;
        }

        const auto_TaskConfig::auto_ExecuterSetting::auto_SystemSetting::SystemSetting& SystemSetting() const {
            return system_setting_;
        }

        const auto_TaskConfig::auto_ExecuterSetting::auto_IdleSystemSetting::IdleSystemSetting& IdleSystemSetting() const {
            return idle_system_setting_;
        }

        bool AllPriorityEnable() const {
            return all_priority_enable_;
        }

        bool AllCpuAffinityEnable() const {
            return all_cpu_affinity_enable_;
        }
...
public:
    ...
    void update_from_yaml(const YAML::Node& auto_yaml_node) {
        ...
        std::vector<auto_TaskConfig::auto_TaskList::auto_ResidentGroup::auto_NodeList::NodeList> NodeList() const {
            return node_list_;
        }

        const auto_TaskConfig::auto_TaskList::auto_ResidentGroup::auto_TimerSetting::TimerSetting& TimerSetting() const {
            return timer_setting_;
        }

        const auto_TaskConfig::auto_TaskList::auto_ResidentGroup::auto_SystemSetting::SystemSetting& SystemSetting() const {
            return system_setting_;
        }

        const auto_TaskConfig::auto_TaskList::auto_ResidentGroup::auto_LaunchSetting::LaunchSetting& LaunchSetting() const {
...
public:
    ...
    void update_from_yaml(const YAML::Node& auto_yaml_node) {
        ...
        std::vector<auto_TaskConfig::auto_TaskList::auto_StandbyGroup::auto_NodeList::NodeList> NodeList() const {
            return node_list_;
        }

        const auto_TaskConfig::auto_TaskList::auto_StandbyGroup::auto_TimerSetting::TimerSetting& TimerSetting() const {
            return timer_setting_;
        }

        const auto_TaskConfig::auto_TaskList::auto_StandbyGroup::auto_SystemSetting::SystemSetting& SystemSetting() const {
            return system_setting_;
        }
...
public:
    ...
    void update_from_yaml(const YAML::Node& auto_yaml_node) {
        ...
        std::vector<auto_TaskConfig::auto_TaskList::auto_ResidentGroup::ResidentGroup> ResidentGroup() const {
            return resident_group_;
        }

        std::vector<auto_TaskConfig::auto_TaskList::auto_StandbyGroup::StandbyGroup> StandbyGroup() const {
            return standby_group_;
        }
...
public:
    ...
    void update_from_yaml(const YAML::Node& auto_yaml_node) {
        ...
        std::vector<std::string> ForceInitNode() const {
            return force_init_node_;
        }
...
public:
    ...
    void update_from_yaml(const YAML::Node& auto_yaml_node) {
        ...
        std::vector<auto_TaskConfig::auto_ExclusiveTaskGroup::auto_TaskList::TaskList> TaskList() const {
            return task_list_;
        }
...
public:
    ...
    void update_from_yaml(const YAML::Node& auto_yaml_node) {
        ...
        const auto_TaskConfig::auto_ExecuterSetting::ExecuterSetting& ExecuterSetting() const {
            return executer_setting_;
        }

        const auto_TaskConfig::auto_TaskList::TaskList& TaskList() const {
            return task_list_;
        }

        std::vector<auto_TaskConfig::auto_ExclusiveTaskGroup::ExclusiveTaskGroup> ExclusiveTaskGroup() const {
            return exclusive_task_group_;
        }
